...
class ConvHis():
    ...
    def init_conv(self, input_case, target_case, init_pos_attribute_list, init_neg_attribute_list, init_parent_attribute):
        ...
        with open('new_case_01.json', 'r') as f:
            self.new_case_01 = json.load(f)
        if input_case == 1649:
            self.attribute_description = self.new_case_01[str(input_case)]
        else:
            self.attribute_description = [0.] * self.attribute_num
    ...
    def add_new_attribute(self, pos_attribute_set, neg_attribute_set, parent_attribute):
        # print("add_new_attribute:")
        # print("pos_attribute_set: ", pos_attribute_set)
        # print("neg_attribute_set: ", neg_attribute_set)
        # print("parent_attribute: ",parent_attribute)
        # print("before self.candidate_list: ", len(self.candidate_list))
        ...
        # print("after self.candidate_list: ", len(self.candidate_list))
    ...
    def get_attribute_entropy(self):
        if len(self.candidate_list) == 0:
            return [0.] * self.parent_attribute_num
